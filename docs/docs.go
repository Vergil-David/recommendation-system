...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/interactions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Взаємодія користувача",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/recommendations.AddInteractionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/recommendations.AddInteractionResponse"
                        }
                    },
                    "400": {
                        "description": "Невірний запит або interaction type",
                        "schema": {
                            "$ref": "#/definitions/recommendations.ErrorResponse"
                        }
                    },
                    "401": {
                        "description": "Неавторизовано",
        ...
        "/interactions/items": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "CSV список item_id, наприклад 1,2,3",
                        "name": "ids",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/recommendations.GetInteractionStatesResponse"
                        }
                    },
                    "400": {
                        "description": "Невірні query-параметри",
                        "schema": {
                            "$ref": "#/definitions/recommendations.ErrorResponse"
                        }
                    },
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/library.GetLibraryMoviesResponse"
                        }
                    },
                    "401": {
                        "description": "Неавторизовано",
                        "schema": {
                            "$ref": "#/definitions/library.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Внутрішня помилка сервера",
        ...
        "/recommendations": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Ліміт рекомендацій (default 20, max 50)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/recommendations.GetRecommendationsResponse"
                        }
                    },
                    "400": {
                        "description": "Невірні query-параметри",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/recommendations.GetFriendRecommendationsResponse"
                        }
                    },
                    "400": {
                        "description": "Невірні query-параметри",
    ...
    "definitions": {
        ...
        "library.GetLibraryMoviesResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/library.MovieItemResponse"
                    }
                }
            }
        },
        "library.MovieItemResponse": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "recommendations.AddInteractionRequest": {
            "type": "object",
            "required": [
                "item_id",
                "type"
        ...
        "recommendations.AddInteractionResponse": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string",
        ...
        "recommendations.FriendRecommendationItemResponse": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
                ...
                "reason": {
                    "type": "string",
                    "example": "Liked by 3 of your friends"
                },
                "score": {
                    "type": "integer",
                    "example": 3
        ...
        "recommendations.GetFriendRecommendationsResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/recommendations.FriendRecommendationItemResponse"
                    }
                }
            }
        },
        "recommendations.GetInteractionStatesResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/recommendations.InteractionStateResponse"
                    }
                }
            }
        },
        "recommendations.GetRecommendationsResponse": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/recommendations.RecommendationItemResponse"
                    }
                }
            }
        },
        "recommendations.InteractionStateResponse": {
            "type": "object",
            "properties": {
                "disliked": {
                    "type": "boolean"
        ...
        "recommendations.RecommendationItemResponse": {
            ...
            "properties": {
                ...
                "reason": {
                    "type": "string",
                    "example": "Because you liked similar Ukrainian movies"
                },
                "release_year": {
                    "type": "integer"
                },
